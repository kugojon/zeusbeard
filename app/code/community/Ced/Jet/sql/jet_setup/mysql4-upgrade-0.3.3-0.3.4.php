...
$table = $installer->getConnection()
    ...
    ->addColumn(
        'product_id', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
        'nullable'  => false,
        ), 'Product Id'
    )
    ->addForeignKey(
...
if(!Mage::getModel('catalog/resource_eav_attribute')->loadByCode('catalog_product', 'jet_product_validation')->getId()) {
    $setup->addAttribute(
        'catalog_product', 'jet_product_validation', array(
        'group'         => 'jetcom',
...
if(!Mage::getModel('catalog/resource_eav_attribute')->loadByCode('catalog_product', 'jet_product_validation_error')->getId()) {
    $setup->addAttribute(
        'catalog_product', 'jet_product_validation_error', array(
        'group'         => 'jetcom',
...
if(!Mage::getModel('catalog/resource_eav_attribute')->loadByCode('catalog_product', 'standard_identifier')->getId()) {
    $setup->addAttribute(
        'catalog_product', 'standard_identifier', array(
        'group'         => 'jetcom',
