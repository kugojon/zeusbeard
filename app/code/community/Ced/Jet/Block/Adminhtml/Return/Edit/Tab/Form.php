        ...
        if (count($data) > 0) {
            ...
            $fieldset->addField(
                'agreeto_return', 'select', array(
                    'label' => Mage::helper('jet')->__('Agree To Return Charge'),
            ...
            $fieldset->addField(
                'not_agreeto_return', 'select', array(
                    'label' => Mage::helper('jet')->__('Return Charge Feedback If Not Agree To Return Charge'),
                    'class' => '',
                    'required' => false,
                    'name' => "not_agreeto_return",
                    //'name'      => 'not_agreeto_return[]',
                    'value' => $data["not_agreeto_return"],
                    'values' => Mage::helper('jet')->returnchargefeedbackOptArray(),
                    'note' => 'If No that means the merchant not agrees to wholly pay the return charge to Jet.com from the return notification.',
                )
            );
