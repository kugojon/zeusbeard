    ...
    public function customerLogin($observer)
    {
        ...
        if (!$customer->getCustomerActivated()) {
            ...
            if ($this->_checkRequestRoute('customer', 'account', 'createpost')) {
                 ...
                 */
                $message = $helper->__('Thank you for applying to Zeus Wholesale! We can’t wait for you to be a part of the Zeus family. We’ll review your application and e-mail you in 2 business days with the status of you application. Beard on!');
