...
class Magmodules_Snippets_Block_Adminhtml_Config_Form_Field_Attributes
    extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    /**
     * Magmodules_Snippets_Block_Adminhtml_Config_Form_Field_Attributes constructor.
     */
    public function __construct()
    {
        $layout = Mage::app()->getFrontController()->getAction()->getLayout();
        $rendererType = $layout->createBlock(
            'snippets/adminhtml_config_form_renderer_select',
            '',
            array('is_render_to_js_template' => true)
        );
        $rendererType->setOptions(
            Mage::getModel('snippets/adminhtml_system_config_source_attributes')->toOptionArray()
        );
        ...
        $this->_renders['type'] = $rendererType;
