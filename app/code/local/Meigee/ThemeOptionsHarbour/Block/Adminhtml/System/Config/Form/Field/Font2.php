 ...
 *
 */
class Meigee_ThemeOptionsHarbour_Block_Adminhtml_System_Config_Form_Field_Font2 extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="themeoptionsharbour_gfont_preview" style="font-size:20px; margin-top:5px;">The quick brown fox jumps over the lazy dog</div>
		<script>
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
				if($("meigee_harbour_design_appearance_gfont")){
					this.fontElement = $("meigee_harbour_design_appearance_gfont");
				}
                this.previewElement = $("themeoptionsharbour_gfont_preview");
                this.loadedFonts = "";
