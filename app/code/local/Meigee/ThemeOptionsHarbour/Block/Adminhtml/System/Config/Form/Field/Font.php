 ...
 *
 */
class Meigee_ThemeOptionsHarbour_Block_Adminhtml_System_Config_Form_Field_Font extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="themeoptionsharbour_gfontmain_preview" style="font-size:20px; margin-top:5px;">The quick brown fox jumps over the lazy dog</div>
		<script>
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
				if($("meigee_harbour_design_appearance_gfontmain")){
					this.fontElement = $("meigee_harbour_design_appearance_gfontmain");
				}
                this.previewElement = $("themeoptionsharbour_gfontmain_preview");
                this.loadedFonts = "";
