 ...
 *
 */
class Meigee_ThemeOptionsHarbour_Model_Activation extends Mage_Core_Model_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsHarbour/etc/import/cms.xml';
