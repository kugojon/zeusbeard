...
class Magestore_Affiliateplus_Helper_Account extends Mage_Core_Helper_Abstract {
    ...
    //hainh 22-07-2014
    public function createAffiliateAccount($address, $paypalEmail, $customer, $notification, $post, $successMessage, $referredBy=null, $coreSession=null) {
        $account = Mage::getModel('affiliateplus/account')
                ...
                /*Social website*/
				->setData('add_urlso', $post['add_urlso'])
				->setData('website_url', $post['website_url'])
				->setData('social_facebook', $post['social_facebook'])
				->setData('social_instagram', $post['social_instagram'])
				->setData('other', $post['other'])
				/*
                  hainh update for adding referring website
                  22-04-2014
                 */
             /*    ->setData('referring_website', $post['referring_website']) */
                /*
