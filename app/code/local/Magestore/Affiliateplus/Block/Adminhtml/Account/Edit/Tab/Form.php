...
class Magestore_Affiliateplus_Block_Adminhtml_Account_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
		...
		$fieldset->addField('add_urlso', 'select', array(
        'label' => Mage::helper('affiliateplus')->__('Where will you be placing your affiliate link?'),
        'title' => Mage::helper('affiliateplus')->__('Where will you be placing your affiliate link?'),
        'name' => 'add_urlso',
        'required' => true,
        'options' => array(
			'website' => 'Website (E-commerce store, blog, forum)',
            'social' => 'Social Media (Facebook, Instagram, Twitter, etc.)',
            'both' => 'Both',
        ),
    ));
		/*Website*/
		...
		$fieldset->addField('website_url', 'text', array(
            'label' => Mage::helper('affiliateplus')->__('Website URL'),
			'name' => 'website_url'
        ));
		/*Social*/
		$fieldset->addField('label_test', 'label', array(
        
        'label' => Mage::helper('affiliateplus')->__('Social Media Username(s):')
		));
        echo Mage::helper('affiliateplus')->__('Social Media Username(s):');
			$fieldset->addField('social_facebook', 'text', array(
            'label' => Mage::helper('affiliateplus')->__('Facebook'),
			'name' => 'social_facebook'
        ));
		$fieldset->addField('social_instagram', 'text', array(
            'label' => Mage::helper('affiliateplus')->__('Instagram'),
			 'name' => 'social_instagram'
        ));
		
		$fieldset->addField('other', 'text', array(
            'label' => Mage::helper('affiliateplus')->__('Other(Twitter, YouTube,etc.)'),
			'name' => 'other'
        ));
        /*
