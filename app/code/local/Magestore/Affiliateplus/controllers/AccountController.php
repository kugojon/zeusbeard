...
class Magestore_Affiliateplus_AccountController extends Mage_Core_Controller_Front_Action {
    ...
    public function editAction() {
		...
		$formData['website_url'] = $session->getAccount()->getWebsiteUrl();
		$formData['social_facebook'] = $session->getAccount()->getSocialFacebook();
		$formData['social_instagram'] = $session->getAccount()->getSocialInstagram();
		$formData['other'] = $session->getAccount()->getOther();
        /*
    ...
    public function editPostAction() {
        ...
        try {
			...
			/*Social website*/
			$account->setData('add_urlso', $data['add_urlso']);
			 $account->setData('website_url', $data['website_url']);
			 $account->setData('social_facebook', $data['social_facebook']);
			 $account->setData('social_instagram', $data['social_instagram']);
			 $account->setData('other', $data['other']);
    ...
    public function createPostAction() {
        ...
        try {
            ...
            */
            $successMessage = '';
            $successMessage = Mage::helper('affiliateplus/account')->createAffiliateAccount($address, $data['paypal_email'], $customer, $this->getRequest()->getPost('notification'), $this->getRequest()->getPost(), $successMessage, $referredBy, $coreSession);
