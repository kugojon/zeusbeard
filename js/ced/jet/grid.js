...
varienGrid.prototype = {
    ...
    reload : function(url){
        ...
        if(this.useAjax){
            //Undefined case
            var profileProducts = this.reloadParams['in_profile_product[]'];
            delete this.reloadParams['in_profile_product[]'];
            if(typeof profileProducts != 'undefined')
                this.reloadParams['in_profile_product'] = profileProducts.join(',');
    ...
    apply: function() {
        ...
        if(this.useAjax && item.url) {
            /*console.log(this.formFieldName);
             console.log(this.grid.reloadParams);
             return;*/
